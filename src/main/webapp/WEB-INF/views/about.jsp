                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                           <ul class="navbar-nav navbar-nav-right">
                                ...
                                <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="/about">About Us</a></li>
                                <li class="nav-item"><a class="nav-item-child nav-item-hover" href="#">Team</a></li>
                                <li class="nav-item"><a class="nav-item-child nav-item-hover" href="#">Portfolio</a></li>
                                <li class="nav-item"><a class="nav-item-child nav-item-hover" href="#">Services</a></li>
                                <li class="nav-item"><a class="nav-item-child nav-item-hover" href="#">Work with us</a></li>
