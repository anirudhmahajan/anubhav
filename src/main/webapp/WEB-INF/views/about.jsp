            ...
            <div class="content container">
                <div class="row">
                    ...
                    <div class="col-xs-6 text-right">
                        <p class="margin-b-0"><a class="color-base fweight-700" href="http://keenthemes.com/preview/asentus/">Andarchitects</a> Developed by: <a class="color-base fweight-700" href="http://www.keenthemes.com/">Anirudh</a></p>
                    </div>
                </div>
                <!--// end row -->
            </div>
