                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                             <ul class="navbar-nav navbar-nav-right">
                                ...
                                <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="/contact">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- End Navbar Collapse -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 sm-margin-b-50">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            <h3><a href="#">Agra</a> <span class="text-uppercase margin-l-20">Head Office</span></h3>
                            <p>43, Nehru Nagar, Civil Lines, Agra -282002</p>
                            <ul class="list-unstyled contact-list">
                                <li><i class="margin-r-10 color-base icon-call-out"></i> +91 9837635562</li>
                                <li><i class="margin-r-10 color-base icon-envelope"></i> info@andarchitects.co.in</li>
                            </ul>
                        </div>
                    </div>
                    <!-- End Contact List -->
<!-- 
        ...
        <!-- Google Map -->
        <div id="map1" class="map height-400">
		<iframe src="https://www.google.com/maps/embed/v1/place?q=27.207815%2C78.009179&key=AIzaSyCecRm5IE7muoEB2D92sOb2m3nstTZ2evI"  width="100%" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
